...
public class IOSInAppPurchaseManager : ISN_Singleton<IOSInAppPurchaseManager> {
	...
	public static IOSInAppPurchaseManager JsbInstance
	{
		get { return Instance; }
	}
	#endregion
    ...
    {
#if !UNITY_EDITOR
		IOSNativeMarketBridge.finishTransaction(transactionIdentifier);
#endif
    }
	...
	private void onStoreDataReceived(string data) {
		...
		for(int i = 0; i < storeData.Length; i+=8) {
