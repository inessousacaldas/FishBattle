...
#region 更新图集用于的回调
    public static event Action<UIAtlas> UpdateAtlasCallBack;

    public static void UpdateAtlasEnd(UIAtlas atlas)
    {
        if (UpdateAtlasCallBack != null)
        {
            UpdateAtlasCallBack(atlas);
        }
    }
#endregion
