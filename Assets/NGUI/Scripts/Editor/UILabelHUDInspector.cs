...
[CustomEditor(typeof(UILabelHUD), true)]
public class UILabelHUDInspector : Editor
{
    ...
    bool ShouldDrawProperties ()
	{
		mLabel = target as UILabelHUD;
		...
		EditorGUI.EndDisabledGroup();
        NGUIEditorTools.DrawProperty("Color Tint", serializedObject, "mColor", GUILayout.MinWidth(10f));
        NGUIEditorTools.DrawProperty("width", serializedObject, "mWidth", GUILayout.MinWidth(10f));
        NGUIEditorTools.DrawProperty("height", serializedObject, "mHeight", GUILayout.MinWidth(10f));
        return isValid;
	}
}
