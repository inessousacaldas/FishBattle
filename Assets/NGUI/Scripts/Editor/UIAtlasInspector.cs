...
public class UIAtlasInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		if (mat != null)
		{
			...
			if(GUILayout.Button("Sort Digital")){
				NGUIEditorTools.RegisterUndo("Sort Digital", mAtlas);
				mAtlas.SortDigital();
		}

			if(GUILayout.Button("Sort Alphabetically")){
				NGUIEditorTools.RegisterUndo("Sort Alphabetically", mAtlas);
				mAtlas.SortAlphabetically();
			}
		}
