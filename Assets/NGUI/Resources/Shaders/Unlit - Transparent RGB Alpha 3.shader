...
Shader "Hidden/Unlit/Transparent RGB Alpha 3"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata_t v)
			{
				...
				o.gray = sign(dot(v.color,fixed4(1,0,0,0)));
				return o;
			}
			...
			half4 frag (v2f IN) : COLOR
			{
                ...
                fixed3 grayColor = dot(col.rgb,fixed3(0.222,0.707,0.071));
                col.rgb = lerp(grayColor, col.rgb, IN.gray);
