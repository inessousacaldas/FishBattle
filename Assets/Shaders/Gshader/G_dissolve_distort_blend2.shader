...
////// Emissive:
                ...
                return fixed4(finalColor,saturate(((_MainTex_var.a*_MainTex_Power)*(1.0 - step((dot(_Dissolve_Tex_var.rgb,float3(0.3,0.59,0.11))*_Dissolve_Tex_var.a),lerp( _diss_amount, ((1.0 - i.vertexColor.a)*1.01+-0.01), _particle_controlA )))*dot((_MaskTex_var.rgb*_MaskTex_var.a),float3(0.3,0.59,0.11)))));
            }
            ENDCG
        }
    }
