...
_ReflectPower("_ReflectPower", Range(0,1) ) = 0
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf BlinnPhongEditor alpha exclude_path:deferred exclude_path:prepass noshadow noambient novertexlights nolightmap nodirlightmap nofog nometa noforwardadd 
		#pragma target 3.0
