...
// File     :  ArenaReportViewControllerAutoGen.cs
...
public partial class GarandArenaReportViewController:MonoViewController<GarandArenaReportView>
    , IGarandArenaReportViewController
    {
	    //机器自动生成的事件订阅
