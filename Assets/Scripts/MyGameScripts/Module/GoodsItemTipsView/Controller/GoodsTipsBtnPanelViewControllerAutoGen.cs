...
public partial interface IGoodsTipsBtnPanelViewController
{
...
public partial class GoodsTipsBtnPanelViewController:MonolessViewController<GoodsTipsBtnPanelView>, IGoodsTipsBtnPanelViewController
{
    //机器自动生成的事件绑定
