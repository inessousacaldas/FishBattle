...
public class GMModel : IModuleModel
{
    ...
    private void ModuleBtnInit()
    {
        ...
        mGMData.Add("战斗调试", new GMData[]
        {
            ...
            new GMData("单机模式切换", TestInfoSimulate),

#if UNITY_EDITOR
            new GMData("技能编辑器", OnBattleSkillEditorClick),
            new GMData("新技能编辑器", OnNewBattleSkillEditorClick)
#endif
        });
        ...
        mGMData.Add("公会", new GMData[]
        {
            ...
            new GMData("清除所有公会","#removeAllGuild"),
            new GMData("增加宝箱积分","#addGuildBoxPoint 公会id 数量"),
            new GMData("建筑升级","#upgradeGuildWorkshop 公会id 建筑"),
            new GMData("建筑降级","#degradeGuildWorkshop 公会id 建筑")
        });
        AddModule("引导/排行榜");
        mGMData.Add("引导/排行榜",new GMData[]
        {
            new GMData("清除引导进度"," #GuideClear 0"),
            new GMData("设置引导"+'\n'+"进度达到上限", "#GuideFinish 0"),
            new GMData("清除排行榜信息","#rank clear 0")
        });
        AddModule("每日问答");
        mGMData.Add("每日问答",new GMData[]
        {
            new GMData("重置问答"+'\n'+"(文字)","#resetQuestionInfo 1"),
            new GMData("重置问答"+'\n'+"(图片)", "#resetQuestionInfo 2"),
            new GMData("(抢答）","#getQuestionEntityNotify 题目id")
        });
    }
...
//#endif
    ...
    private void OnNewBattleSkillEditorClick()
    {
