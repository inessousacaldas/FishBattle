...
// File     :  QuizariumViewControllerAutoGen.cs
// this file is generate by tool
// **********************************************************************

using UniRx;

public partial interface IQuizariumViewController : ICloseView
{
     UniRx.IObservable<Unit> OnCloseBtn_UIButtonClick{get;}

}

public partial class QuizariumViewController:FRPBaseController<
    QuizariumViewController
    , QuizariumView
    , IQuizariumViewController
    , IQuestionData>
    , IQuizariumViewController
    {
	    //机器自动生成的事件订阅
