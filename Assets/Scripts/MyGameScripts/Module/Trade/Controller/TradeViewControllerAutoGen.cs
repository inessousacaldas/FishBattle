...
// File     :  TradeViewControllerAutoGen.cs
// this file is generate by tool
// **********************************************************************

using UniRx;

public partial interface ITradeViewController : ICloseView
{
     UniRx.IObservable<Unit> OnCloseBtn_UIButtonClick{get;}

}

public partial class TradeViewController:FRPBaseController<
    TradeViewController
    , TradeView
    , ITradeViewController
    , ITradeData>
    , ITradeViewController
    {
	    //机器自动生成的事件订阅
