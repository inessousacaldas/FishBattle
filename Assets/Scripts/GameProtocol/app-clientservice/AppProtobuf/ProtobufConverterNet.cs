...
public class ProtobufConverterNet{
    ...
    Dictionary<int, Action<System.Object, System.Object>> dtoFillIntoActions = new Dictionary<int, Action<System.Object, System.Object>>(546);
	Dictionary<int, Action<System.Object, System.Object>> dtoFillFromActions = new Dictionary<int, Action<System.Object, System.Object>>(546);
private static ProtobufConverterNet instance = new ProtobufConverterNet();
		...
		public void SceneMapConverter_fillFrom(AppDto.SceneMap target, SceneMap source){
			...
			target.backTeamUnable = source.backTeamUnable;
		}
		...
		public void AfterLoginDtoConverter_fillFrom(AppDto.AfterLoginDto target, AfterLoginDto source){
			...
			target.roleCreateTime = source.roleCreateTime;
			target.y = source.y;
			if (source.stateBarDtos != null) {
				List<AppDto.StateBarDto> items = new List<AppDto.StateBarDto>();
				target.stateBarDtos = items;
				foreach (GameObjectTypedMessage item in source.stateBarDtos) {
					int message_type_id = item.message_type_id;
					object result = ProtobufUtilsNet.parseFrom(message_type_id,item.message_data);
					if (result == null && !(result is AppDto.StateBarDto))
						throw new IOException("parse data error");
					items.Add((AppDto.StateBarDto)result);
				}
			}else{
				List<AppDto.StateBarDto> items = new List<AppDto.StateBarDto>();
				target.stateBarDtos = items;
		...
		public void AfterLoginDtoConverter_fillInto(AppDto.AfterLoginDto source, AfterLoginDto target){
			...
			target.y=source.y;
			if (source.stateBarDtos != null){
				foreach(AppDto.StateBarDto stateBarDtos in source.stateBarDtos){
					GameObjectTypedMessage msgStateBarDtos = ProtobufUtilsNet.packInto(stateBarDtos);
					if (msgStateBarDtos == null)
						throw new IOException("pack data error");
					target.stateBarDtos.Add(msgStateBarDtos);
				}
			}
		}
		...
		public void VideoConverter_fillFrom(AppDto.Video target, Video source){
			...
			if (source.watchIds != null) {
				List<long> items = new List<long>();
				target.watchIds = items;
                foreach (long item in source.watchIds)
                    items.Add(item);
			}else{
				List<long> items = new List<long>();
				target.watchIds = items;
		...
		public void VideoConverter_fillInto(AppDto.Video source, Video target){
			...
			target.battleTypeId=source.battleTypeId;
			if (source.watchIds != null){
				foreach(long watchIds in source.watchIds)
					target.watchIds.Add(watchIds);
			}
		}
		...
		public void TeamMemberStatusDtoConverter_fillFrom(AppDto.TeamMemberStatusDto target, TeamMemberStatusDto source){
			...
			target.awayReason = source.awayReason;
		}
		...
		public void PropsConverter_fillFrom(AppDto.Props target, Props source){
			...
			target.easyToUse = source.easyToUse;
		}
		...
		public void MailChangeIdsNotifyConverter_fillFrom(AppDto.MailChangeIdsNotify target, MailChangeIdsNotify source){
			...
			target.allExtra = source.allExtra;
		}
		...
		public void BattleWatchDtoConverter_fillFrom(AppDto.BattleWatchDto target, BattleWatchDto source){
			...
			target.watchTeamId = source.watchTeamId;
		}
		...
		public void EquipmentExtraDtoConverter_fillFrom(AppDto.EquipmentExtraDto target, EquipmentExtraDto source){
			...
			target.curResetCount = source.curResetCount;
		}
		...
		public void EquipmentInfoDtoConverter_fillFrom(AppDto.EquipmentInfoDto target, EquipmentInfoDto source){
			...
			target.curSmithCount = source.curSmithCount;
			target.curResetCount = source.curResetCount;
		}
		...
		public void GuildTreasuryConverter_fillFrom(AppDto.GuildTreasury target, GuildTreasury source){
			...
			target.needPoint = source.needPoint;
			target.rewardWealths = source.rewardWealths;
			target.rewardProps = source.rewardProps;
		}
		...
		public void GuildTreasuryConverter_fillInto(AppDto.GuildTreasury source, GuildTreasury target){
			...
			target.needPoint=source.needPoint;
			if(source.rewardWealths!=null)
				target.rewardWealths = source.rewardWealths;
			if(source.rewardProps!=null)
				target.rewardProps = source.rewardProps;
		}
		...
		public void TradeGoodsDtoConverter_fillFrom(AppDto.TradeGoodsDto target, TradeGoodsDto source){
			...
			target.originalPrice = source.originalPrice;
			target.itemId = source.itemId;
			if ( source.parentTradeGoodsDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentTradeGoodsDto);
			}
		}
		...
		public void TradeGoodsDtoConverter_fillInto(AppDto.TradeGoodsDto source, TradeGoodsDto target){
			...
			target.originalPrice=source.originalPrice;
			target.itemId=source.itemId;
			if ( target.parentTradeGoodsDto == null ) {
				target.parentTradeGoodsDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentTradeGoodsDto);
		}
		...
		public void GuildDetailInfoDtoConverter_fillFrom(AppDto.GuildDetailInfoDto target, GuildDetailInfoDto source){
			...
			if ( source.parentGuildDetailInfoDto != null ) {
				...
				target.buildingInfo = retBuildingInfo;
									...
									if (source.magEvents!=null) {
				AppDto.GuildMagEventDto retMagEvents = new AppDto.GuildMagEventDto();
				GuildMagEventDtoConverter_fillFrom(retMagEvents, source.magEvents);
				target.magEvents = retMagEvents;
			}
					}
		...
		public void GuildDetailInfoDtoConverter_fillInto(AppDto.GuildDetailInfoDto source, GuildDetailInfoDto target){
			...
			if(source.magEvents!=null){
				GuildMagEventDto protobufModel = new GuildMagEventDto();
				GuildMagEventDtoConverter_fillInto(source.magEvents, protobufModel);
				target.magEvents = protobufModel;
			}
		}
		...
		public void ScheduleActivityConverter_fillFrom(AppDto.ScheduleActivity target, ScheduleActivity source){
			...
			target.smartGuideId = source.smartGuideId;
			target.normalRegainFallRewardId = source.normalRegainFallRewardId;
			target.perfectRegainFallRewardId = source.perfectRegainFallRewardId;
			target.normalVirtualItemId = source.normalVirtualItemId;
			target.normalRegainCost = source.normalRegainCost;
			target.perfectVirtualItemId = source.perfectVirtualItemId;
			target.perfectRegainCost = source.perfectRegainCost;
			target.regainItemsView = source.regainItemsView;
			target.regainTimes = source.regainTimes;
		}
		...
		public void ScheduleActivityConverter_fillInto(AppDto.ScheduleActivity source, ScheduleActivity target){
			...
			target.perfectVirtualItemId=source.perfectVirtualItemId;
			target.perfectRegainCost=source.perfectRegainCost;
			if(source.regainItemsView!=null)
				target.regainItemsView = source.regainItemsView;
			target.regainTimes=source.regainTimes;
		}
		...
		public void ScheduleDtoConverter_fillFrom(AppDto.ScheduleDto target, ScheduleDto source){
			...
			if (source.regainInfos != null) {
				List<AppDto.RegainInfoDto> items = new List<AppDto.RegainInfoDto>();
				target.regainInfos = items;
				foreach (RegainInfoDto item in source.regainInfos) {
					AppDto.RegainInfoDto result = new AppDto.RegainInfoDto();
					RegainInfoDtoConverter_fillFrom(result, item);
					items.Add(result);
				}
			}else{
				List<AppDto.RegainInfoDto> items = new List<AppDto.RegainInfoDto>();
		...
		public void ScheduleDtoConverter_fillInto(AppDto.ScheduleDto source, ScheduleDto target){
			...
			if (source.regainInfos != null){
				foreach(AppDto.RegainInfoDto regainInfos in source.regainInfos){
					RegainInfoDto protobufModel = new RegainInfoDto();
					RegainInfoDtoConverter_fillInto(regainInfos, protobufModel);
					target.regainInfos.Add(protobufModel);
				}
			}
		}
		...
		public void PlayerCopyMissionDtoConverter_fillFrom(AppDto.PlayerCopyMissionDto target, PlayerCopyMissionDto source){
			...
			target.sceneId = source.sceneId;
			target.finish = source.finish;
			target.changeScene = source.changeScene;
		}
		...
		public void KungfuInfoDtoConverter_fillFrom(AppDto.KungfuInfoDto target, KungfuInfoDto source){
			...
			target.matchState = source.matchState;
						if (source.winRankInfoDto!=null) {
				AppDto.RankInfoDto retWinRankInfoDto = new AppDto.RankInfoDto();
				RankInfoDtoConverter_fillFrom(retWinRankInfoDto, source.winRankInfoDto);
				target.winRankInfoDto = retWinRankInfoDto;
			}
									if (source.loseRankInfoDto!=null) {
				AppDto.RankInfoDto retLoseRankInfoDto = new AppDto.RankInfoDto();
				RankInfoDtoConverter_fillFrom(retLoseRankInfoDto, source.loseRankInfoDto);
				target.loseRankInfoDto = retLoseRankInfoDto;
			}
						target.matchEndTime = source.matchEndTime;
		}
		...
		public void KungfuInfoDtoConverter_fillInto(AppDto.KungfuInfoDto source, KungfuInfoDto target){
			...
			if(source.winRankInfoDto!=null){
				RankInfoDto protobufModel = new RankInfoDto();
				RankInfoDtoConverter_fillInto(source.winRankInfoDto, protobufModel);
				target.winRankInfoDto = protobufModel;
			}
			if(source.loseRankInfoDto!=null){
				RankInfoDto protobufModel = new RankInfoDto();
				RankInfoDtoConverter_fillInto(source.loseRankInfoDto, protobufModel);
				target.loseRankInfoDto = protobufModel;
			}
			target.matchEndTime=source.matchEndTime;
		}
		...
		public void CopyExtraConverter_fillFrom(AppDto.CopyExtra target, CopyExtra source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void CopyExtraConverter_fillInto(AppDto.CopyExtra source, CopyExtra target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void BattleWatchExitConverter_fillFrom(AppDto.BattleWatchExit target, BattleWatchExit source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void BattleWatchExitConverter_fillInto(AppDto.BattleWatchExit source, BattleWatchExit target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void GuildWelfareConverter_fillFrom(AppDto.GuildWelfare target, GuildWelfare source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.id = source.id;
			target.name = source.name;
			target.shortDes = source.shortDes;
			target.buttonDefault = source.buttonDefault;
			target.icon = source.icon;
		}

		public void GuildWelfareConverter_fillInto(AppDto.GuildWelfare source, GuildWelfare target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if(source.name!=null)
				target.name = source.name;
			if(source.shortDes!=null)
				target.shortDes = source.shortDes;
			if(source.buttonDefault!=null)
				target.buttonDefault = source.buttonDefault;
			if(source.icon!=null)
				target.icon = source.icon;
		}
		public void PlayerCopyExtraMissionDtoConverter_fillFrom(AppDto.PlayerCopyExtraMissionDto target, PlayerCopyExtraMissionDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentPlayerCopyExtraMissionDto != null ) {
				PlayerMissionDtoConverter_fillFrom(target,source.parentPlayerCopyExtraMissionDto);
			}
		}

		public void PlayerCopyExtraMissionDtoConverter_fillInto(AppDto.PlayerCopyExtraMissionDto source, PlayerCopyExtraMissionDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentPlayerCopyExtraMissionDto == null ) {
				target.parentPlayerCopyExtraMissionDto = new PlayerMissionDto();
			}
			PlayerMissionDtoConverter_fillInto(source,target.parentPlayerCopyExtraMissionDto);
		}
		public void RegainInfoDtoConverter_fillFrom(AppDto.RegainInfoDto target, RegainInfoDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentRegainInfoDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentRegainInfoDto);
			}
			target.regainId = source.regainId;
			target.id = source.id;
		...
		public void RegainInfoDtoConverter_fillInto(AppDto.RegainInfoDto source, RegainInfoDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentRegainInfoDto == null ) {
				target.parentRegainInfoDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentRegainInfoDto);
			target.regainId=source.regainId;
			target.id=source.id;
			target.receive=source.receive;
			target.expiredTime=source.expiredTime;
		...
		public void GuildBoxDtoConverter_fillFrom(AppDto.GuildBoxDto target, GuildBoxDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentGuildBoxDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentGuildBoxDto);
			}
			target.hasPoint = source.hasPoint;
			if (source.events != null) {
				List<AppDto.GuildEventDto> items = new List<AppDto.GuildEventDto>();
				target.events = items;
				foreach (GuildEventDto item in source.events) {
					AppDto.GuildEventDto result = new AppDto.GuildEventDto();
					GuildEventDtoConverter_fillFrom(result, item);
					items.Add(result);
				}
			}else{
				List<AppDto.GuildEventDto> items = new List<AppDto.GuildEventDto>();
		...
		public void GuildBoxDtoConverter_fillInto(AppDto.GuildBoxDto source, GuildBoxDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentGuildBoxDto == null ) {
				target.parentGuildBoxDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentGuildBoxDto);
			target.hasPoint=source.hasPoint;
			if (source.events != null){
				foreach(AppDto.GuildEventDto events in source.events){
					GuildEventDto protobufModel = new GuildEventDto();
					GuildEventDtoConverter_fillInto(events, protobufModel);
					target.events.Add(protobufModel);
				}
			}
			target.needPoint=source.needPoint;
		}
		public void GuildWelfareDtoConverter_fillFrom(AppDto.GuildWelfareDto target, GuildWelfareDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentGuildWelfareDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentGuildWelfareDto);
			}
			target.donateCount = source.donateCount;
		}

		public void GuildWelfareDtoConverter_fillInto(AppDto.GuildWelfareDto source, GuildWelfareDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentGuildWelfareDto == null ) {
				target.parentGuildWelfareDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentGuildWelfareDto);
			target.donateCount=source.donateCount;
		}
		public void GuildEventDtoConverter_fillFrom(AppDto.GuildEventDto target, GuildEventDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentGuildEventDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentGuildEventDto);
			}
			target.time = source.time;
			target.content = source.content;
		}

		public void GuildEventDtoConverter_fillInto(AppDto.GuildEventDto source, GuildEventDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentGuildEventDto == null ) {
				target.parentGuildEventDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentGuildEventDto);
			target.time=source.time;
			if(source.content!=null)
				target.content = source.content;
		}
		public void GuildPointBoxConverter_fillFrom(AppDto.GuildPointBox target, GuildPointBox source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.id = source.id;
			target.pointsFromula = source.pointsFromula;
			target.dayLimit = source.dayLimit;
		}

		public void GuildPointBoxConverter_fillInto(AppDto.GuildPointBox source, GuildPointBox target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.id=source.id;
			if(source.pointsFromula!=null)
				target.pointsFromula = source.pointsFromula;
			target.dayLimit=source.dayLimit;
		}
		public void ProtectSubmitDtoConverter_fillFrom(AppDto.ProtectSubmitDto target, ProtectSubmitDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
				...
				target.submitNpc = retSubmitNpc;
						...
						if ( source.parentProtectSubmitDto != null ) {
				SubmitDtoConverter_fillFrom(target,source.parentProtectSubmitDto);
			}
		}

		public void ProtectSubmitDtoConverter_fillInto(AppDto.ProtectSubmitDto source, ProtectSubmitDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if ( target.parentProtectSubmitDto == null ) {
				target.parentProtectSubmitDto = new SubmitDto();
			}
			SubmitDtoConverter_fillInto(source,target.parentProtectSubmitDto);
		}
		public void PlayerRedPackDtoConverter_fillFrom(AppDto.PlayerRedPackDto target, PlayerRedPackDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerRedPackDtoConverter_fillInto(AppDto.PlayerRedPackDto source, PlayerRedPackDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void RedPackDetailDtoConverter_fillFrom(AppDto.RedPackDetailDto target, RedPackDetailDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentRedPackDetailDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentRedPackDetailDto);
			}
			target.id = source.id;
			target.playerName = source.playerName;
			target.word = source.word;
						if (source.best!=null) {
				AppDto.PlayerRedPackDto retBest = new AppDto.PlayerRedPackDto();
				PlayerRedPackDtoConverter_fillFrom(retBest, source.best);
				target.best = retBest;
			}
									if (source.worst!=null) {
				AppDto.PlayerRedPackDto retWorst = new AppDto.PlayerRedPackDto();
				PlayerRedPackDtoConverter_fillFrom(retWorst, source.worst);
				target.worst = retWorst;
			}
						if (source.detail != null) {
				List<AppDto.PlayerRedPackDto> items = new List<AppDto.PlayerRedPackDto>();
				target.detail = items;
				foreach (PlayerRedPackDto item in source.detail) {
					AppDto.PlayerRedPackDto result = new AppDto.PlayerRedPackDto();
					PlayerRedPackDtoConverter_fillFrom(result, item);
					items.Add(result);
				}
			}else{
				List<AppDto.PlayerRedPackDto> items = new List<AppDto.PlayerRedPackDto>();
			...
			target.enough = source.enough;
			target.total = source.total;
			target.open = source.open;
			target.type = source.type;
		}

		public void RedPackDetailDtoConverter_fillInto(AppDto.RedPackDetailDto source, RedPackDetailDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentRedPackDetailDto == null ) {
				target.parentRedPackDetailDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentRedPackDetailDto);
			target.id=source.id;
			if(source.playerName!=null)
				target.playerName = source.playerName;
			if(source.word!=null)
				target.word = source.word;
			if(source.best!=null){
				PlayerRedPackDto protobufModel = new PlayerRedPackDto();
				PlayerRedPackDtoConverter_fillInto(source.best, protobufModel);
				target.best = protobufModel;
			}
			if(source.worst!=null){
				PlayerRedPackDto protobufModel = new PlayerRedPackDto();
				PlayerRedPackDtoConverter_fillInto(source.worst, protobufModel);
				target.worst = protobufModel;
			}
			if (source.detail != null){
				foreach(AppDto.PlayerRedPackDto detail in source.detail){
					PlayerRedPackDto protobufModel = new PlayerRedPackDto();
					PlayerRedPackDtoConverter_fillInto(detail, protobufModel);
					target.detail.Add(protobufModel);
				}
			}
			target.enough=source.enough;
			target.total=source.total;
		...
		public void RedPackInfoDtoConverter_fillFrom(AppDto.RedPackInfoDto target, RedPackInfoDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentRedPackInfoDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentRedPackInfoDto);
			}
			if (source.detailDtos != null) {
				List<AppDto.RedPackDetailDto> items = new List<AppDto.RedPackDetailDto>();
				target.detailDtos = items;
				foreach (RedPackDetailDto item in source.detailDtos) {
					AppDto.RedPackDetailDto result = new AppDto.RedPackDetailDto();
					RedPackDetailDtoConverter_fillFrom(result, item);
					items.Add(result);
				}
			}else{
				List<AppDto.RedPackDetailDto> items = new List<AppDto.RedPackDetailDto>();
		...
		public void RedPackInfoDtoConverter_fillInto(AppDto.RedPackInfoDto source, RedPackInfoDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentRedPackInfoDto == null ) {
				target.parentRedPackInfoDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentRedPackInfoDto);
			if (source.detailDtos != null){
				foreach(AppDto.RedPackDetailDto detailDtos in source.detailDtos){
					RedPackDetailDto protobufModel = new RedPackDetailDto();
					RedPackDetailDtoConverter_fillInto(detailDtos, protobufModel);
					target.detailDtos.Add(protobufModel);
				}
			}
		}
		public void RedPackNotifyConverter_fillFrom(AppDto.RedPackNotify target, RedPackNotify source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void RedPackNotifyConverter_fillInto(AppDto.RedPackNotify source, RedPackNotify target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void RedPackConverter_fillFrom(AppDto.RedPack target, RedPack source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void RedPackConverter_fillInto(AppDto.RedPack source, RedPack target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void WealthDelayNotifyConverter_fillFrom(AppDto.WealthDelayNotify target, WealthDelayNotify source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.virtualItemId = source.virtualItemId;
			target.delayValue = source.delayValue;
			target.returnValue = source.returnValue;
			target.delayType = source.delayType;
		}

		public void WealthDelayNotifyConverter_fillInto(AppDto.WealthDelayNotify source, WealthDelayNotify target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerGuildMissionDtoConverter_fillFrom(AppDto.PlayerGuildMissionDto target, PlayerGuildMissionDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentPlayerGuildMissionDto != null ) {
				PlayerMissionDtoConverter_fillFrom(target,source.parentPlayerGuildMissionDto);
			}
			target.curRings = source.curRings;
		}

		public void PlayerGuildMissionDtoConverter_fillInto(AppDto.PlayerGuildMissionDto source, PlayerGuildMissionDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentPlayerGuildMissionDto == null ) {
				target.parentPlayerGuildMissionDto = new PlayerMissionDto();
			}
			PlayerMissionDtoConverter_fillInto(source,target.parentPlayerGuildMissionDto);
			target.curRings=source.curRings;
		}
		public void NpcPlayerMonsterConverter_fillFrom(AppDto.NpcPlayerMonster target, NpcPlayerMonster source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.copySelf = source.copySelf;
			if (source.sceneAppearanceStaticGroupIds != null) {
				List<int> items = new List<int>();
				target.sceneAppearanceStaticGroupIds = items;
				foreach (int item in source.sceneAppearanceStaticGroupIds)
			...
			if ( source.parentNpcPlayerMonster != null ) {
				NpcMonsterConverter_fillFrom(target,source.parentNpcPlayerMonster);
			}
		}

		public void NpcPlayerMonsterConverter_fillInto(AppDto.NpcPlayerMonster source, NpcPlayerMonster target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if ( target.parentNpcPlayerMonster == null ) {
				target.parentNpcPlayerMonster = new NpcMonster();
			}
			NpcMonsterConverter_fillInto(source,target.parentNpcPlayerMonster);
		}
		public void GuildMagEventDtoConverter_fillFrom(AppDto.GuildMagEventDto target, GuildMagEventDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentGuildMagEventDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentGuildMagEventDto);
			}
			if (source.events != null) {
				List<AppDto.GuildEventDto> items = new List<AppDto.GuildEventDto>();
				target.events = items;
		...
		public void GuildMagEventDtoConverter_fillInto(AppDto.GuildMagEventDto source, GuildMagEventDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentGuildMagEventDto == null ) {
				target.parentGuildMagEventDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentGuildMagEventDto);
			if (source.events != null){
				foreach(AppDto.GuildEventDto events in source.events){
					GuildEventDto protobufModel = new GuildEventDto();
					GuildEventDtoConverter_fillInto(events, protobufModel);
		...
		public void SpeakSubmitDtoConverter_fillFrom(AppDto.SpeakSubmitDto target, SpeakSubmitDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentSpeakSubmitDto != null ) {
				SubmitDtoConverter_fillFrom(target,source.parentSpeakSubmitDto);
			}
			target.acceptRadius = source.acceptRadius;
						if (source.acceptScene!=null) {
				AppDto.SceneInfoDto retAcceptScene = new AppDto.SceneInfoDto();
		...
		public void SpeakSubmitDtoConverter_fillInto(AppDto.SpeakSubmitDto source, SpeakSubmitDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentSpeakSubmitDto == null ) {
				target.parentSpeakSubmitDto = new SubmitDto();
			}
			SubmitDtoConverter_fillInto(source,target.parentSpeakSubmitDto);
			target.acceptRadius=source.acceptRadius;
			if(source.acceptScene!=null){
				SceneInfoDto protobufModel = new SceneInfoDto();
				SceneInfoDtoConverter_fillInto(source.acceptScene, protobufModel);
		...
		public void AccessTitleConditionConverter_fillFrom(AppDto.AccessTitleCondition target, AccessTitleCondition source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentAccessTitleCondition != null ) {
				LogicParamAdapterConverter_fillFrom(target,source.parentAccessTitleCondition);
			}
		}

		public void AccessTitleConditionConverter_fillInto(AppDto.AccessTitleCondition source, AccessTitleCondition target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentAccessTitleCondition == null ) {
				target.parentAccessTitleCondition = new LogicParamAdapter();
			}
			LogicParamAdapterConverter_fillInto(source,target.parentAccessTitleCondition);
		}
		public void AccessTitleCondition_1Converter_fillFrom(AppDto.AccessTitleCondition_1 target, AccessTitleCondition_1 source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentAccessTitleCondition_1 != null ) {
				AccessTitleConditionConverter_fillFrom(target,source.parentAccessTitleCondition_1);
			}
			target.minutes = source.minutes;
		}

		public void AccessTitleCondition_1Converter_fillInto(AppDto.AccessTitleCondition_1 source, AccessTitleCondition_1 target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentAccessTitleCondition_1 == null ) {
				target.parentAccessTitleCondition_1 = new AccessTitleCondition();
			}
			AccessTitleConditionConverter_fillInto(source,target.parentAccessTitleCondition_1);
			target.minutes=source.minutes;
		}
		public void AccessTitleCondition_2Converter_fillFrom(AppDto.AccessTitleCondition_2 target, AccessTitleCondition_2 source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentAccessTitleCondition_2 != null ) {
				AccessTitleConditionConverter_fillFrom(target,source.parentAccessTitleCondition_2);
			}
			target.days = source.days;
		}

		public void AccessTitleCondition_2Converter_fillInto(AppDto.AccessTitleCondition_2 source, AccessTitleCondition_2 target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentAccessTitleCondition_2 == null ) {
				target.parentAccessTitleCondition_2 = new AccessTitleCondition();
			}
			AccessTitleConditionConverter_fillInto(source,target.parentAccessTitleCondition_2);
			target.days=source.days;
		}
		public void TitleConverter_fillFrom(AppDto.Title target, Title source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if (source.accessTitleCondition!=null && source.accessTitleCondition is GameObjectTypedMessage) {
				GameObjectTypedMessage itemAccessTitleCondition = source.accessTitleCondition;
				System.Object objAccessTitleCondition = ProtobufUtilsNet.parseFrom(itemAccessTitleCondition.message_type_id,itemAccessTitleCondition.message_data);
				if (objAccessTitleCondition == null)
					throw new IOException("parse data error");
				target.accessTitleCondition = (AppDto.AccessTitleCondition)objAccessTitleCondition;
			}
			target.texture = source.texture;
			target.effect = source.effect;
			target.showOrder = source.showOrder;
		}

		public void TitleConverter_fillInto(AppDto.Title source, Title target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if(source.access!=null)
				target.access = source.access;
			if(source.accessTitleCondition != null){
				GameObjectTypedMessage protobufModel = ProtobufUtilsNet.packInto(source.accessTitleCondition);
				if (protobufModel == null)
					throw new IOException("pack data error");
				target.accessTitleCondition = protobufModel;
			}
		...
		public void GuildMembersDtoConverter_fillFrom(AppDto.GuildMembersDto target, GuildMembersDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentGuildMembersDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentGuildMembersDto);
			}
			if (source.memberList != null) {
				List<AppDto.GuildMemberDto> items = new List<AppDto.GuildMemberDto>();
				target.memberList = items;
		...
		public void GuildMembersDtoConverter_fillInto(AppDto.GuildMembersDto source, GuildMembersDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentGuildMembersDto == null ) {
				target.parentGuildMembersDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentGuildMembersDto);
			if (source.memberList != null){
				foreach(AppDto.GuildMemberDto memberList in source.memberList){
					GuildMemberDto protobufModel = new GuildMemberDto();
					GuildMemberDtoConverter_fillInto(memberList, protobufModel);
		...
		public void NpcSceneRobberMonsterConverter_fillFrom(AppDto.NpcSceneRobberMonster target, NpcSceneRobberMonster source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.robberType = source.robberType;
			target.refreshWeight = source.refreshWeight;
			if ( source.parentNpcSceneRobberMonster != null ) {
				NpcSceneMonsterConverter_fillFrom(target,source.parentNpcSceneRobberMonster);
			}
		}

		public void NpcSceneRobberMonsterConverter_fillInto(AppDto.NpcSceneRobberMonster source, NpcSceneRobberMonster target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.robberType=source.robberType;
			target.refreshWeight=source.refreshWeight;
			if ( target.parentNpcSceneRobberMonster == null ) {
				target.parentNpcSceneRobberMonster = new NpcSceneMonster();
			}
			NpcSceneMonsterConverter_fillInto(source,target.parentNpcSceneRobberMonster);
		}
		public void DailyLimitConverter_fillFrom(AppDto.DailyLimit target, DailyLimit source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void DailyLimitConverter_fillInto(AppDto.DailyLimit source, DailyLimit target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void WeeklyLimitConverter_fillFrom(AppDto.WeeklyLimit target, WeeklyLimit source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void WeeklyLimitConverter_fillInto(AppDto.WeeklyLimit source, WeeklyLimit target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void QuartzSmithDtoConverter_fillFrom(AppDto.QuartzSmithDto target, QuartzSmithDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentQuartzSmithDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentQuartzSmithDto);
			}
			target.curSmithCount = source.curSmithCount;
		}

		public void QuartzSmithDtoConverter_fillInto(AppDto.QuartzSmithDto source, QuartzSmithDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentQuartzSmithDto == null ) {
				target.parentQuartzSmithDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentQuartzSmithDto);
			target.curSmithCount=source.curSmithCount;
		}
		public void GuildDonateConverter_fillFrom(AppDto.GuildDonate target, GuildDonate source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.id = source.id;
			target.assest = source.assest;
			target.contribute = source.contribute;
			target.maxCommit = source.maxCommit;
		}

		public void GuildDonateConverter_fillInto(AppDto.GuildDonate source, GuildDonate target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void StateBarConverter_fillFrom(AppDto.StateBar target, StateBar source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			target.needUnfold = source.needUnfold;
		}

		public void StateBarConverter_fillInto(AppDto.StateBar source, StateBar target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			...
			if(source.description!=null)
				target.description = source.description;
			if(source.subheading!=null)
				target.subheading = source.subheading;
			target.needUnfold=source.needUnfold;
		}
		public void ScaleStateBarDtoConverter_fillFrom(AppDto.ScaleStateBarDto target, ScaleStateBarDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentScaleStateBarDto != null ) {
				StateBarDtoConverter_fillFrom(target,source.parentScaleStateBarDto);
			}
			target.scale = source.scale;
			target.expireAt = source.expireAt;
		}

		public void ScaleStateBarDtoConverter_fillInto(AppDto.ScaleStateBarDto source, ScaleStateBarDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentScaleStateBarDto == null ) {
				target.parentScaleStateBarDto = new StateBarDto();
			}
			StateBarDtoConverter_fillInto(source,target.parentScaleStateBarDto);
			target.scale=source.scale;
			target.expireAt=source.expireAt;
		}
		public void StateBarDtoConverter_fillFrom(AppDto.StateBarDto target, StateBarDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void StateBarDtoConverter_fillInto(AppDto.StateBarDto source, StateBarDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerTransformNotifyConverter_fillFrom(AppDto.PlayerTransformNotify target, PlayerTransformNotify source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerTransformNotifyConverter_fillInto(AppDto.PlayerTransformNotify source, PlayerTransformNotify target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void RobberSateBarDtoConverter_fillFrom(AppDto.RobberSateBarDto target, RobberSateBarDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentRobberSateBarDto != null ) {
				StateBarDtoConverter_fillFrom(target,source.parentRobberSateBarDto);
			}
			target.expiredTime = source.expiredTime;
			target.configId = source.configId;
		}

		public void RobberSateBarDtoConverter_fillInto(AppDto.RobberSateBarDto source, RobberSateBarDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentRobberSateBarDto == null ) {
				target.parentRobberSateBarDto = new StateBarDto();
			}
			StateBarDtoConverter_fillInto(source,target.parentRobberSateBarDto);
			target.expiredTime=source.expiredTime;
			target.configId=source.configId;
		}
		public void AccessTitleCondition_3Converter_fillFrom(AppDto.AccessTitleCondition_3 target, AccessTitleCondition_3 source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentAccessTitleCondition_3 != null ) {
				AccessTitleConditionConverter_fillFrom(target,source.parentAccessTitleCondition_3);
			}
			target.endTime = source.endTime;
		}

		public void AccessTitleCondition_3Converter_fillInto(AppDto.AccessTitleCondition_3 source, AccessTitleCondition_3 target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentAccessTitleCondition_3 == null ) {
				target.parentAccessTitleCondition_3 = new AccessTitleCondition();
			}
			AccessTitleConditionConverter_fillInto(source,target.parentAccessTitleCondition_3);
			if(source.endTime!=null)
				target.endTime = source.endTime;
		}
		public void PlayerDeleteTitleNotifyConverter_fillFrom(AppDto.PlayerDeleteTitleNotify target, PlayerDeleteTitleNotify source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerDeleteTitleNotifyConverter_fillInto(AppDto.PlayerDeleteTitleNotify source, PlayerDeleteTitleNotify target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerTitleDtoConverter_fillFrom(AppDto.PlayerTitleDto target, PlayerTitleDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			target.titleId = source.titleId;
			target.expiredTime = source.expiredTime;
			target.gainTime = source.gainTime;
			target.titleName = source.titleName;
		}

		public void PlayerTitleDtoConverter_fillInto(AppDto.PlayerTitleDto source, PlayerTitleDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void PlayerTitleListDtoConverter_fillFrom(AppDto.PlayerTitleListDto target, PlayerTitleListDto source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( source.parentPlayerTitleListDto != null ) {
				GeneralResponseConverter_fillFrom(target,source.parentPlayerTitleListDto);
			}
			if (source.playerTitleDtos != null) {
				List<AppDto.PlayerTitleDto> items = new List<AppDto.PlayerTitleDto>();
				target.playerTitleDtos = items;
				foreach (PlayerTitleDto item in source.playerTitleDtos) {
					AppDto.PlayerTitleDto result = new AppDto.PlayerTitleDto();
					PlayerTitleDtoConverter_fillFrom(result, item);
					items.Add(result);
				}
			}else{
				List<AppDto.PlayerTitleDto> items = new List<AppDto.PlayerTitleDto>();
		...
		public void PlayerTitleListDtoConverter_fillInto(AppDto.PlayerTitleListDto source, PlayerTitleListDto target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
			if ( target.parentPlayerTitleListDto == null ) {
				target.parentPlayerTitleListDto = new GeneralResponse();
			}
			GeneralResponseConverter_fillInto(source,target.parentPlayerTitleListDto);
			if (source.playerTitleDtos != null){
				foreach(AppDto.PlayerTitleDto playerTitleDtos in source.playerTitleDtos){
					PlayerTitleDto protobufModel = new PlayerTitleDto();
					PlayerTitleDtoConverter_fillInto(playerTitleDtos, protobufModel);
					target.playerTitleDtos.Add(protobufModel);
				}
			}
			target.titleId=source.titleId;
			if(source.titleName!=null)
		...
		public void KungfuBattleInfoNotifyConverter_fillFrom(AppDto.KungfuBattleInfoNotify target, KungfuBattleInfoNotify source){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
		...
		public void KungfuBattleInfoNotifyConverter_fillInto(AppDto.KungfuBattleInfoNotify source, KungfuBattleInfoNotify target){
			if (source == null)
				throw new System.ArgumentNullException("source == null");
			if (target == null)
				throw new System.ArgumentNullException("target == null");
    ...
    private void initFillFromActions() {
    	...
    	dtoFillFromActions.Add(734, (destObject, srcObject) => instance.CopyExtraConverter_fillFrom(destObject as AppDto.CopyExtra, srcObject as CopyExtra));
    	dtoFillFromActions.Add(735, (destObject, srcObject) => instance.BattleWatchExitConverter_fillFrom(destObject as AppDto.BattleWatchExit, srcObject as BattleWatchExit));
    	dtoFillFromActions.Add(736, (destObject, srcObject) => instance.GuildWelfareConverter_fillFrom(destObject as AppDto.GuildWelfare, srcObject as GuildWelfare));
    	dtoFillFromActions.Add(737, (destObject, srcObject) => instance.PlayerCopyExtraMissionDtoConverter_fillFrom(destObject as AppDto.PlayerCopyExtraMissionDto, srcObject as PlayerCopyExtraMissionDto));
    	dtoFillFromActions.Add(738, (destObject, srcObject) => instance.RegainInfoDtoConverter_fillFrom(destObject as AppDto.RegainInfoDto, srcObject as RegainInfoDto));
    	dtoFillFromActions.Add(739, (destObject, srcObject) => instance.GuildBoxDtoConverter_fillFrom(destObject as AppDto.GuildBoxDto, srcObject as GuildBoxDto));
    	dtoFillFromActions.Add(741, (destObject, srcObject) => instance.GuildWelfareDtoConverter_fillFrom(destObject as AppDto.GuildWelfareDto, srcObject as GuildWelfareDto));
    	dtoFillFromActions.Add(742, (destObject, srcObject) => instance.GuildEventDtoConverter_fillFrom(destObject as AppDto.GuildEventDto, srcObject as GuildEventDto));
    	dtoFillFromActions.Add(743, (destObject, srcObject) => instance.GuildPointBoxConverter_fillFrom(destObject as AppDto.GuildPointBox, srcObject as GuildPointBox));
    	dtoFillFromActions.Add(744, (destObject, srcObject) => instance.ProtectSubmitDtoConverter_fillFrom(destObject as AppDto.ProtectSubmitDto, srcObject as ProtectSubmitDto));
    	dtoFillFromActions.Add(745, (destObject, srcObject) => instance.PlayerRedPackDtoConverter_fillFrom(destObject as AppDto.PlayerRedPackDto, srcObject as PlayerRedPackDto));
    	dtoFillFromActions.Add(746, (destObject, srcObject) => instance.RedPackDetailDtoConverter_fillFrom(destObject as AppDto.RedPackDetailDto, srcObject as RedPackDetailDto));
    	dtoFillFromActions.Add(747, (destObject, srcObject) => instance.RedPackInfoDtoConverter_fillFrom(destObject as AppDto.RedPackInfoDto, srcObject as RedPackInfoDto));
    	dtoFillFromActions.Add(748, (destObject, srcObject) => instance.RedPackNotifyConverter_fillFrom(destObject as AppDto.RedPackNotify, srcObject as RedPackNotify));
    	dtoFillFromActions.Add(749, (destObject, srcObject) => instance.RedPackConverter_fillFrom(destObject as AppDto.RedPack, srcObject as RedPack));
    	dtoFillFromActions.Add(750, (destObject, srcObject) => instance.WealthDelayNotifyConverter_fillFrom(destObject as AppDto.WealthDelayNotify, srcObject as WealthDelayNotify));
    	dtoFillFromActions.Add(751, (destObject, srcObject) => instance.PlayerGuildMissionDtoConverter_fillFrom(destObject as AppDto.PlayerGuildMissionDto, srcObject as PlayerGuildMissionDto));
    	dtoFillFromActions.Add(752, (destObject, srcObject) => instance.NpcPlayerMonsterConverter_fillFrom(destObject as AppDto.NpcPlayerMonster, srcObject as NpcPlayerMonster));
    	dtoFillFromActions.Add(753, (destObject, srcObject) => instance.GuildMagEventDtoConverter_fillFrom(destObject as AppDto.GuildMagEventDto, srcObject as GuildMagEventDto));
    	dtoFillFromActions.Add(754, (destObject, srcObject) => instance.SpeakSubmitDtoConverter_fillFrom(destObject as AppDto.SpeakSubmitDto, srcObject as SpeakSubmitDto));
    	dtoFillFromActions.Add(755, (destObject, srcObject) => instance.PlayerTreasuryMissionDtoConverter_fillFrom(destObject as AppDto.PlayerTreasuryMissionDto, srcObject as PlayerTreasuryMissionDto));
    	dtoFillFromActions.Add(756, (destObject, srcObject) => instance.AccessTitleConditionConverter_fillFrom(destObject as AppDto.AccessTitleCondition, srcObject as AccessTitleCondition));
    	dtoFillFromActions.Add(757, (destObject, srcObject) => instance.AccessTitleCondition_1Converter_fillFrom(destObject as AppDto.AccessTitleCondition_1, srcObject as AccessTitleCondition_1));
    	dtoFillFromActions.Add(758, (destObject, srcObject) => instance.AccessTitleCondition_2Converter_fillFrom(destObject as AppDto.AccessTitleCondition_2, srcObject as AccessTitleCondition_2));
    	dtoFillFromActions.Add(759, (destObject, srcObject) => instance.TitleConverter_fillFrom(destObject as AppDto.Title, srcObject as Title));
    	dtoFillFromActions.Add(760, (destObject, srcObject) => instance.GuildMembersDtoConverter_fillFrom(destObject as AppDto.GuildMembersDto, srcObject as GuildMembersDto));
    	dtoFillFromActions.Add(761, (destObject, srcObject) => instance.NpcSceneRobberMonsterConverter_fillFrom(destObject as AppDto.NpcSceneRobberMonster, srcObject as NpcSceneRobberMonster));
    	dtoFillFromActions.Add(762, (destObject, srcObject) => instance.DailyLimitConverter_fillFrom(destObject as AppDto.DailyLimit, srcObject as DailyLimit));
    	dtoFillFromActions.Add(763, (destObject, srcObject) => instance.WeeklyLimitConverter_fillFrom(destObject as AppDto.WeeklyLimit, srcObject as WeeklyLimit));
    	dtoFillFromActions.Add(764, (destObject, srcObject) => instance.QuartzSmithDtoConverter_fillFrom(destObject as AppDto.QuartzSmithDto, srcObject as QuartzSmithDto));
    	dtoFillFromActions.Add(765, (destObject, srcObject) => instance.GuildDonateConverter_fillFrom(destObject as AppDto.GuildDonate, srcObject as GuildDonate));
    	dtoFillFromActions.Add(766, (destObject, srcObject) => instance.StateBarConverter_fillFrom(destObject as AppDto.StateBar, srcObject as StateBar));
    	dtoFillFromActions.Add(767, (destObject, srcObject) => instance.ScaleStateBarDtoConverter_fillFrom(destObject as AppDto.ScaleStateBarDto, srcObject as ScaleStateBarDto));
    	dtoFillFromActions.Add(768, (destObject, srcObject) => instance.StateBarDtoConverter_fillFrom(destObject as AppDto.StateBarDto, srcObject as StateBarDto));
    	dtoFillFromActions.Add(769, (destObject, srcObject) => instance.PlayerTransformNotifyConverter_fillFrom(destObject as AppDto.PlayerTransformNotify, srcObject as PlayerTransformNotify));
    	dtoFillFromActions.Add(770, (destObject, srcObject) => instance.RobberSateBarDtoConverter_fillFrom(destObject as AppDto.RobberSateBarDto, srcObject as RobberSateBarDto));
    	dtoFillFromActions.Add(771, (destObject, srcObject) => instance.AccessTitleCondition_3Converter_fillFrom(destObject as AppDto.AccessTitleCondition_3, srcObject as AccessTitleCondition_3));
    	dtoFillFromActions.Add(772, (destObject, srcObject) => instance.PlayerDeleteTitleNotifyConverter_fillFrom(destObject as AppDto.PlayerDeleteTitleNotify, srcObject as PlayerDeleteTitleNotify));
    	dtoFillFromActions.Add(773, (destObject, srcObject) => instance.PlayerTitleDtoConverter_fillFrom(destObject as AppDto.PlayerTitleDto, srcObject as PlayerTitleDto));
    	dtoFillFromActions.Add(774, (destObject, srcObject) => instance.PlayerTitleListDtoConverter_fillFrom(destObject as AppDto.PlayerTitleListDto, srcObject as PlayerTitleListDto));
    	dtoFillFromActions.Add(775, (destObject, srcObject) => instance.KungfuBattleInfoNotifyConverter_fillFrom(destObject as AppDto.KungfuBattleInfoNotify, srcObject as KungfuBattleInfoNotify));
    }
    ...
    private void initFillIntoActions() {
        ...
        dtoFillIntoActions.Add(734, (srcObject, destObject) => instance.CopyExtraConverter_fillInto(srcObject as AppDto.CopyExtra, destObject as CopyExtra));
        dtoFillIntoActions.Add(735, (srcObject, destObject) => instance.BattleWatchExitConverter_fillInto(srcObject as AppDto.BattleWatchExit, destObject as BattleWatchExit));
        dtoFillIntoActions.Add(736, (srcObject, destObject) => instance.GuildWelfareConverter_fillInto(srcObject as AppDto.GuildWelfare, destObject as GuildWelfare));
        dtoFillIntoActions.Add(737, (srcObject, destObject) => instance.PlayerCopyExtraMissionDtoConverter_fillInto(srcObject as AppDto.PlayerCopyExtraMissionDto, destObject as PlayerCopyExtraMissionDto));
        dtoFillIntoActions.Add(738, (srcObject, destObject) => instance.RegainInfoDtoConverter_fillInto(srcObject as AppDto.RegainInfoDto, destObject as RegainInfoDto));
        dtoFillIntoActions.Add(739, (srcObject, destObject) => instance.GuildBoxDtoConverter_fillInto(srcObject as AppDto.GuildBoxDto, destObject as GuildBoxDto));
        dtoFillIntoActions.Add(741, (srcObject, destObject) => instance.GuildWelfareDtoConverter_fillInto(srcObject as AppDto.GuildWelfareDto, destObject as GuildWelfareDto));
        dtoFillIntoActions.Add(742, (srcObject, destObject) => instance.GuildEventDtoConverter_fillInto(srcObject as AppDto.GuildEventDto, destObject as GuildEventDto));
        dtoFillIntoActions.Add(743, (srcObject, destObject) => instance.GuildPointBoxConverter_fillInto(srcObject as AppDto.GuildPointBox, destObject as GuildPointBox));
        dtoFillIntoActions.Add(744, (srcObject, destObject) => instance.ProtectSubmitDtoConverter_fillInto(srcObject as AppDto.ProtectSubmitDto, destObject as ProtectSubmitDto));
        dtoFillIntoActions.Add(745, (srcObject, destObject) => instance.PlayerRedPackDtoConverter_fillInto(srcObject as AppDto.PlayerRedPackDto, destObject as PlayerRedPackDto));
        dtoFillIntoActions.Add(746, (srcObject, destObject) => instance.RedPackDetailDtoConverter_fillInto(srcObject as AppDto.RedPackDetailDto, destObject as RedPackDetailDto));
        dtoFillIntoActions.Add(747, (srcObject, destObject) => instance.RedPackInfoDtoConverter_fillInto(srcObject as AppDto.RedPackInfoDto, destObject as RedPackInfoDto));
        dtoFillIntoActions.Add(748, (srcObject, destObject) => instance.RedPackNotifyConverter_fillInto(srcObject as AppDto.RedPackNotify, destObject as RedPackNotify));
        dtoFillIntoActions.Add(749, (srcObject, destObject) => instance.RedPackConverter_fillInto(srcObject as AppDto.RedPack, destObject as RedPack));
        dtoFillIntoActions.Add(750, (srcObject, destObject) => instance.WealthDelayNotifyConverter_fillInto(srcObject as AppDto.WealthDelayNotify, destObject as WealthDelayNotify));
        dtoFillIntoActions.Add(751, (srcObject, destObject) => instance.PlayerGuildMissionDtoConverter_fillInto(srcObject as AppDto.PlayerGuildMissionDto, destObject as PlayerGuildMissionDto));
        dtoFillIntoActions.Add(752, (srcObject, destObject) => instance.NpcPlayerMonsterConverter_fillInto(srcObject as AppDto.NpcPlayerMonster, destObject as NpcPlayerMonster));
        dtoFillIntoActions.Add(753, (srcObject, destObject) => instance.GuildMagEventDtoConverter_fillInto(srcObject as AppDto.GuildMagEventDto, destObject as GuildMagEventDto));
        dtoFillIntoActions.Add(754, (srcObject, destObject) => instance.SpeakSubmitDtoConverter_fillInto(srcObject as AppDto.SpeakSubmitDto, destObject as SpeakSubmitDto));
        dtoFillIntoActions.Add(755, (srcObject, destObject) => instance.PlayerTreasuryMissionDtoConverter_fillInto(srcObject as AppDto.PlayerTreasuryMissionDto, destObject as PlayerTreasuryMissionDto));
        dtoFillIntoActions.Add(756, (srcObject, destObject) => instance.AccessTitleConditionConverter_fillInto(srcObject as AppDto.AccessTitleCondition, destObject as AccessTitleCondition));
        dtoFillIntoActions.Add(757, (srcObject, destObject) => instance.AccessTitleCondition_1Converter_fillInto(srcObject as AppDto.AccessTitleCondition_1, destObject as AccessTitleCondition_1));
        dtoFillIntoActions.Add(758, (srcObject, destObject) => instance.AccessTitleCondition_2Converter_fillInto(srcObject as AppDto.AccessTitleCondition_2, destObject as AccessTitleCondition_2));
        dtoFillIntoActions.Add(759, (srcObject, destObject) => instance.TitleConverter_fillInto(srcObject as AppDto.Title, destObject as Title));
        dtoFillIntoActions.Add(760, (srcObject, destObject) => instance.GuildMembersDtoConverter_fillInto(srcObject as AppDto.GuildMembersDto, destObject as GuildMembersDto));
        dtoFillIntoActions.Add(761, (srcObject, destObject) => instance.NpcSceneRobberMonsterConverter_fillInto(srcObject as AppDto.NpcSceneRobberMonster, destObject as NpcSceneRobberMonster));
        dtoFillIntoActions.Add(762, (srcObject, destObject) => instance.DailyLimitConverter_fillInto(srcObject as AppDto.DailyLimit, destObject as DailyLimit));
        dtoFillIntoActions.Add(763, (srcObject, destObject) => instance.WeeklyLimitConverter_fillInto(srcObject as AppDto.WeeklyLimit, destObject as WeeklyLimit));
        dtoFillIntoActions.Add(764, (srcObject, destObject) => instance.QuartzSmithDtoConverter_fillInto(srcObject as AppDto.QuartzSmithDto, destObject as QuartzSmithDto));
        dtoFillIntoActions.Add(765, (srcObject, destObject) => instance.GuildDonateConverter_fillInto(srcObject as AppDto.GuildDonate, destObject as GuildDonate));
        dtoFillIntoActions.Add(766, (srcObject, destObject) => instance.StateBarConverter_fillInto(srcObject as AppDto.StateBar, destObject as StateBar));
        dtoFillIntoActions.Add(767, (srcObject, destObject) => instance.ScaleStateBarDtoConverter_fillInto(srcObject as AppDto.ScaleStateBarDto, destObject as ScaleStateBarDto));
        dtoFillIntoActions.Add(768, (srcObject, destObject) => instance.StateBarDtoConverter_fillInto(srcObject as AppDto.StateBarDto, destObject as StateBarDto));
        dtoFillIntoActions.Add(769, (srcObject, destObject) => instance.PlayerTransformNotifyConverter_fillInto(srcObject as AppDto.PlayerTransformNotify, destObject as PlayerTransformNotify));
        dtoFillIntoActions.Add(770, (srcObject, destObject) => instance.RobberSateBarDtoConverter_fillInto(srcObject as AppDto.RobberSateBarDto, destObject as RobberSateBarDto));
        dtoFillIntoActions.Add(771, (srcObject, destObject) => instance.AccessTitleCondition_3Converter_fillInto(srcObject as AppDto.AccessTitleCondition_3, destObject as AccessTitleCondition_3));
        dtoFillIntoActions.Add(772, (srcObject, destObject) => instance.PlayerDeleteTitleNotifyConverter_fillInto(srcObject as AppDto.PlayerDeleteTitleNotify, destObject as PlayerDeleteTitleNotify));
        dtoFillIntoActions.Add(773, (srcObject, destObject) => instance.PlayerTitleDtoConverter_fillInto(srcObject as AppDto.PlayerTitleDto, destObject as PlayerTitleDto));
        dtoFillIntoActions.Add(774, (srcObject, destObject) => instance.PlayerTitleListDtoConverter_fillInto(srcObject as AppDto.PlayerTitleListDto, destObject as PlayerTitleListDto));
        dtoFillIntoActions.Add(775, (srcObject, destObject) => instance.KungfuBattleInfoNotifyConverter_fillInto(srcObject as AppDto.KungfuBattleInfoNotify, destObject as KungfuBattleInfoNotify));
    }
