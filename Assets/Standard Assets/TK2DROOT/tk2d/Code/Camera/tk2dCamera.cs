...
public class tk2dCamera : MonoBehaviour 
{
    ...
    public Vector2 GetScaleForOverride()
    {
        return GetScaleForOverride(this, this.CurrentResolutionOverride, _targetResolution.x, _targetResolution.y);
    }
    ...
    {
        return GetScreenPixelDimensions(this);
    }
