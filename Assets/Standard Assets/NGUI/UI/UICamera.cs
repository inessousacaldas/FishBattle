...
#region 这里对信息进行个注册回调，方便处理
	static int mNotifying = 0;
    public static event Action<GameObject, string, object> NotifyCallback;

    public static void Notify(GameObject go, string funcName, object obj)
    {
        if (NotifyCallback != null)
        {
            NotifyCallback(go, funcName, obj);
        }
        else
        {
            NativeNotify(go, funcName, obj);
        }
    }
	...
	static public void NativeNotify (GameObject go, string funcName, object obj)
	{
