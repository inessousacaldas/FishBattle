...
public class UIScrollView : MonoBehaviour
{
	...
	/// 全局缩放鼠标滑轮滑动
	/// </summary>
	public static float GlobalScrollWheelFactor = 10;
	...
	/// </summary>
    public Action PressUpCallback = null;
	public virtual Bounds bounds
	{
		get
		{
			if (!mCalculatedBounds)
			{
				...
				mBounds.size = mBounds.size - new Vector3(clipSoftness.x*2f,clipSoftness.y*2f,0f);
			}
			return mBounds;
		}
	}
	...
	[HideInInspector]
	public bool usePageScroll = false;	//When use PageScrollView,can not DisableSpring
	/// <summary>
	...
	public void Scroll (float delta)
	{
		if (enabled && NGUITools.GetActive(gameObject) && scrollWheelFactor != 0f)
		{
			...
			mScroll += delta * scrollWheelFactor * GlobalScrollWheelFactor;
		}
	}
...
//难以理解~~为什么NGUI 会做这样的处理。。
//#if UNITY_STANDALONE
//				if (NGUITools.GetActive(centerOnChild) && offset.sqrMagnitude > 0)
//				{
//					centerOnChild.Recenter();
//				}
//#endif
