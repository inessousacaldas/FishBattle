...
public class JsExternalTools
{
    ...
    private static bool mOneKeyBuildAll = false;
    ...
    //[MenuItem("JSB/One Key Build All/One Key Build Step2", false, 153)]
    ...
    {
        return Application.dataPath + "JsExtarnalOneKey";
    }
