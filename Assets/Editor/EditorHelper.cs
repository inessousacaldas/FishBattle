...
public static class EditorHelper
{
    ...
    public static void DrawBoxLabel(string title, string text, bool hasCopyBtn, bool needLayout = true,int pTextWidth =  0)
    {
        if (needLayout)
            EditorGUILayout.BeginHorizontal();

        EditorHelper.DrawBox(title);
        GUILayout.Space(5f);
        EditorHelper.DrawBox(text,pTextWidth);
    ...
    static public bool DrawHeader(string text, string key, bool forceOn, bool minimalistic)
    {
        ...
        if (state)
            ...
            text = "\u25BA " + text;
//        if (GUILayout.Button( text,  GUILayout.Width(200f), GUILayout.Height(20)))
        if (!GUILayout.Toggle(true, text,"dragtab",  GUILayout.Width(200f), GUILayout.Height(20)))
            state = !state;
    ...
    static public string DrawTextField(string title, string value, int width = 50,int pTitleWidth = 0, bool needLayout = true)
    {
        if (needLayout)
            EditorGUILayout.BeginHorizontal();

        EditorHelper.DrawBox(title,pTitleWidth);
    ...
    static public int DrawIntField(string title, int value, int width = 30,int pTitleWidth = 0, bool needLayout = true)
    {
        if (needLayout)
            EditorGUILayout.BeginHorizontal();
    ...
    static public float DrawFloatField(string title, float value, int width = 30,int pTitleWidth = 0, bool needLayout = true)
    {
        if (needLayout)
            EditorGUILayout.BeginHorizontal();
    ...
    public static void DrawBox(string pBoxContent, int pBoxWidth = 0)
    {
        pBoxWidth = pBoxWidth <= 0 ? GetGBLength(pBoxContent) * 12 : pBoxWidth;
        GUILayout.Box(pBoxContent, GUILayout.Width(pBoxWidth));
    }
