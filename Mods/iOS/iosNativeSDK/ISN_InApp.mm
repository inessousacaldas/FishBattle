...
- (void)productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response {
    ...
    for (SKProduct *product in response.products) {
        ...
        NSString *countryCode =[productLocale objectForKey:NSLocaleCountryCode];
        [data appendString:@"|"];
...
-(void) finishTransaction:(NSString *)transactionIdentifier {
    [_storeServer finishTransaction:transactionIdentifier];
}
...
-(void) finishTransaction:(NSString *)transactionIdentifier {
    SKPaymentTransaction *transaction = [_transactions objectForKey:transactionIdentifier];
    if (transaction != nil)
    {
...
extern "C" {
    ...
    void _finishTransaction(char * transactionIdentifier) {
        [[InAppPurchaseManager instance] finishTransaction:[ISN_DataConvertor charToNSString:transactionIdentifier]];
    }
