...
#define CILU_DLL_TAG "CLDLL"
#define CILU_DLL_TAG_LENGTH strlen(CILU_DLL_TAG)
char cilu_is_encrypt_data(char *data);
char *cilu_decrypt_data(char *origData, char isReplacedData, size_t len, size_t *out_len);
